...
<%	
	...
	System.out.println("PostModify.jsp : " + loginID);
	int userID =1;
%>
        ...
        /*     alert("댓글작성 성공!") */
	    	...
	    	$.ajax({
	    		...
	    		success: function(data) {
	    			/* alert("응답을 받음. data.result=" + data.result);  */  //1:성공, 0:실패.
	    			//g_yg = data;
	...
	<div class="main-box">
		<div id="home-box5">
			<div class="home-bar"><span style="font-weight: 800;">Posting</span></div>
				...
				%>
			<div class="big-container" style="height:500px;" bno=<%=post.getPostID()%>><input type="hidden" name="post_id">
				...
				<input type="hidden" name="post_id">
					...
					<div class="content-container">
						<form action="PostModifyServlet" method="post" enctype="multipart/form-data">
								<textarea class="autosize" onkeydown="resize(this)" 
									onkeyup="resize(this)" name="content" style="min-height:100px;"
									placeholder="<%=post.getContent()%>">
								</textarea>
								<script>
									function resize(obj) {
