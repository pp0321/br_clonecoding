            ...
            <div class="header-list">
                ...
                <ul class="tabbed-primary-navigation">
                    ...
                    <li class="navigation-tab">
                        <a style="color:white; pointer-events: none;" class="current-active" href="netflix.jsp"><b>홈</b></a>
                    </li>
                    ...
                    <div class="caret">
                        <role role="menu" tabindex="0" class="account-drop-down">
                            <div class="ptrack-content1">
                                <ul class="profiles">
                                    ...
                                    <li class="profile-link">
                                        <a class="sub-menu-link-icon" onclick="location.href='../jspBR/p01.account.jsp'">
                            ...
                            <div class="account-container">
                                <ul class="account">
                                    <li class="account-information-top" onclick="location.href='../jspBR/p05.account.jsp'">
                            ...
                            <div class="logout-container">
                                <span class="logout-tab" onclick="location.href='../jspCY/Netflix01.jsp'" >넷플릭스에서 로그아웃</span>
                            </div>
                        </role>
                    </div>
                </div>
